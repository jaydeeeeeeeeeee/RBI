...
function sv_m($saved, $key, $fallback='') {
...
<div class="doc-container">
  ...
  <form id="pdfForm" method="post" action="export_mediation.php" target="_blank" style="display:none;">
    ...
    <input type="hidden" name="agreement_text"    id="medAgreement"  value="<?= sv_m($savedMediation,'agreement_text') ?>">
  </form>
  ...
  <div class="doc-body">
    <div class="med-header">
      ...
      <div class="address">254 Sta. Teresita St. Tondo, Manila</div>
    </div>
...
function populateExportFields(){
  document.getElementById('minutesInput').value  = document.getElementById('minutesArea').value;
